...
class TutorialCLI(BaseCLI):
    ...
    def handle_args(self, args) -> None:
        ...
        self.logv(f"Updated defaults! Now you can use the keyword {c.yellow(keyword)} instead of using the full path " 
        ...
        self.logv(f"To run it on your own data you now have to create the {c.yellow('model.npz')} "
